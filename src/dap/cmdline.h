...
#define CMDLINE_PARSER_PACKAGE "DAP"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "DAP"
#endif
...
struct gengetopt_args_info
{
  ...
  int bitsperpixel_arg;	/**< @brief Define the dynamic range (default='8').  */
  char * bitsperpixel_orig;	/**< @brief Define the dynamic range original value given at command line.  */
  const char *bitsperpixel_help; /**< @brief Define the dynamic range help description.  */
  char * flood_arg;	/**< @brief Choose the used flooding technique (0: Salembier, 1: Wilkinson). Default is 1 for >8 bits images, 0 for <= 8 bits images (default='0').  */
  ...
  int lambda_arg;	/**< @brief Lambda value (if the filter is area) (default='100').  */
  char * lambda_orig;	/**< @brief Lambda value (if the filter is area) original value given at command line.  */
  const char *lambda_help; /**< @brief Lambda value (if the filter is area) help description.  */
  char * lvec_arg;	/**< @brief Lambda txt file (default='lvec.txt').  */
  char * lvec_orig;	/**< @brief Lambda txt file original value given at command line.  */
  const char *lvec_help; /**< @brief Lambda txt file help description.  */
